...
export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel:'apple-touch-icon', type:'image/png', href: `${process.env.MODE == 'desarrollo' ? 'http://192.168.200.125:3000/' : 'https://solintek.aplicacionesinteligentes.es/'}apple-touch-icon.png` }
    ]
  },
