            ...
            <div class="mostrar-error">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 586.47858 659.29778"
                    ...
                    <circle cx="281.3585" cy="285.71051" r="51.12006"
                        transform="translate(-26.58509 542.54478) rotate(-85.26884)" fill="#000000" />
                    <path
        ...
        <div v-else>
                    ...
                    <div>
                        ...
                        <div class="opciones-pestañas">
                            ...
                            <b-col class="pestaña" :class="this.pestañaActiva === 'Adjuntos' ? 'active' : 'inactive'
                                " @click="cambiarPestaña('Adjuntos')"><b-icon icon="file-earmark"></b-icon>
                                Adjuntos</b-col>
                            <b-col class="pestaña" :class="this.pestañaActiva === 'Materiales' ? 'active' : 'inactive'
                                " @click="cambiarPestaña('Materiales')"><b-icon
                                    icon="file-earmark"></b-icon>Material</b-col>
                        </div>
                        ...
                        <div class="div-pestaña" v-if="this.pestañaActiva == 'Histórico'">
                            <b-row v-if="checkHistorico() || this.$store.state.Horas.length > 0" class="lista-historica">
                                ...
                                <div v-for="(element, index) in this.$store.state.Horas" :key="index"
                                    class="store-loading historico">
                                    <span>
                                ...
                                <div v-for="(Linea, index) in visita.VisitasLineas" :key="index" class="historico row" v-if="Linea['VisitasLineas::Tipo'] === 'M.Obra' ? true : false && Linea
                                    ...
                                    <div class="historico-tiempo">
                                        <span class="historico-fecha" style="display: block;" >
                                        ...
                                        <span class="historico-fecha"><b-icon icon="calendar4"></b-icon>{{
                                            " " + convertirFecha(Linea["VisitasLineas::linfecha"])
                                        }}</span>
                                    </div>
                                ...
                                <b-modal id="modal-editar-historico" title="Editar Historico" @hide="resetModal">
                                    <form @submit.prevent="handleEdit()">
                                        ...
                                        <b-row class="form-option my-3">
                                            <label>Técnico</label>
                                            <b-form-select v-model="historialAEditar['VisitasLineas::Tec']"
                                                :options="tecnicos" disabled></b-form-select>
                                        </b-row>

                                        <!-- Input de Hora Inicio -->
                                        <b-row class="form-option my-3">
                                            <label>Hora Inicio</label>
                                            <input v-model="historialAEditar['VisitasLineas::HoraInicioReal']"
                                                class="form-input" type="time" name="hora-inicio" required />
                                        </b-row>

                                        <!-- Input de Hora Final -->
                                        <b-row class="form-option my-3">
                                            <label>Hora Fin</label>
                                            <input v-model="historialAEditar['VisitasLineas::HoraFinReal']"
                                                class="form-input" type="time" name="hora-fin" required />
                                        </b-row>

                                        <!-- Input de Descripción -->
                                        <b-row class="form-option my-3">
                                            <label>Descripción</label>
                                            <b-form-textarea v-model="historialAEditar['VisitasLineas::DescripciónArt']"
                                                class="textarea" placeholder="Introduce la acción realizada"
                                ...
                                <div class="boton-carga-parent">
                                    <button v-if="limite < visita.VisitasLineas.length" style="z-index: 9"
                                        class="boton-carga" @click="limite += 5">
                                        Cargar más
                                    </button>

                                    <span class="ml-1" v-if="limite >= visita.VisitasLineas.length">Límite {{
                                        historicoLength() }} registros
                                        alcanzado</span>
            ...
            <div v-if="!FormActive &&
                ...
                <label>
                    ...
                    <b-form-file style="display: none" :state="Boolean(archivoSubir)"
                        accept=".jpg, .png, .pdf, .webp, .jpeg" id="archivo" type="file" name="archivo"
                        v-model="archivoSubir" @change="crearDocumento" />
                </label>
            </div>
    ...
    methods: {
        ...
        editarHistorico(historial) {
            if (historial) {
                ...
                this.tecnicos = [{ value: this.historialAEditar['VisitasLineas::Tec'], text: this.historialAEditar['VisitasLineas::Tec'] }];
