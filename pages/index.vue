  ...
  <div>
    ...
    <div v-if="this.loading === false && (this.visitas.length == 0 || !this.visitas)" class="no-data">
      <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="250" height="250" viewBox="0 0 485.83373 483.5"
        ...
        <path d="M639.89416,433.75h-8v-8a3,3,0,0,0-6,0v8h-8a3,3,0,0,0,0,6h8v8a3,3,0,0,0,6,0v-8h8a3,3,0,0,0,0-6Z"
          transform="translate(-357.08314 -208.25)" fill="#e6e6e6" />
        <path
        ...
        <path
          ...
          transform="translate(-357.08314 -208.25)" fill="#ccc" />
        <polygon points="88.596 471.061 100.856 471.061 104.689 423.773 88.594 423.773 88.596 471.061" fill="#ffb8b8" />
        <path d="M442.55234,675.30845l24.1438-.001h.001a15.38605,15.38605,0,0,1,15.38647,15.38623v.5l-39.53051.00146Z"
          transform="translate(-357.08314 -208.25)" fill="#2f2e41" />
        <polygon points="22.596 471.061 34.856 471.061 40.689 423.773 22.594 423.773 22.596 471.061" fill="#ffb8b8" />
        <path d="M376.55234,675.30845l24.1438-.001h.001a15.38605,15.38605,0,0,1,15.38647,15.38623v.5l-39.53051.00146Z"
          transform="translate(-357.08314 -208.25)" fill="#2f2e41" />
        <path
        ...
        <path
          ...
          transform="translate(-357.08314 -208.25)" fill="#000000" />
        <path
        ...
        <path
          ...
          transform="translate(-357.08314 -208.25)" fill="#2f2e41" />
        <polygon points="38.9 273.343 39.457 240.414 56.9 205.343 42.9 241.343 38.9 273.343" opacity="0.2" />
        <path
...
@media (min-height: 741px) and (max-height: 920px) {
  .tareas-rows {
    height: 800px;
  }
}
